...
import successImage from '../success.png'; // Import the image
  ...
  return (
    <>
      <Head>
        ...
        <meta property="fc:frame:image" content={`${baseUrl}${successImage.src}`} />
      ...
      <main>
        ...
        <p>Success Matters</p>
        <Image src={successImage} alt="Success" width={500} height={300} />
